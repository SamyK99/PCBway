...
public class ServicesFrame extends JFrame {
    ...
    public ServicesFrame() {
        ...
        gbc.gridy = 0;
        // Add cards
        JPanel pcbCard = createServiceCard("PCB PRINTING", "images/Pcb.png");
        gbc.gridx = 0;
        servicesPanel.add(pcbCard, gbc);
        JPanel elecCard = createServiceCard("ELECTRONICS", "images/Electronics.png");
        gbc.gridx = 1;
    ...
    private JPanel createServiceCard(String title, String imagePath) {
