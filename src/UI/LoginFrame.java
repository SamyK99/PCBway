...
public class LoginFrame extends JFrame {
    ...
    public LoginFrame() {
        ...
        leftPanel.setPreferredSize(new Dimension(960, 1080)); //! modified width so it would take half of the page
        ...
        JLabel Textfollow = new JLabel("email address and password.");//! follow up Text
        ...
        //! style email field
       emailField.setBorder(new RoundedBorder(10, new Color(200, 200, 200), 2));// roundedBorder is a new classes created
